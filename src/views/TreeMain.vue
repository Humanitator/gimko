<script setup>
    ...
    import { defaultTree, defaultTreePrivate } from "../firebase/defaultStructs"
    ...
    const createTree = async () => {
        ...
        const treePrivatesObj = structuredClone(defaultTreePrivate);
        await setDoc(doc(db, ("/trees/" + treeRef.id + "/private"), "data"), treePrivatesObj);
